...
def main() -> None:
    ...
    source_column = str(config.get("source_column", "c2"))
    target_column = str(config.get("target_column", "c3"))
    required = {file_column, source_column, target_column}
    ...
    print(f"Generated {generated} images; skipped {skipped} existing outputs.")
